...
class ContentClassifier {
    ...
    private val keywordDatabase: Map<Category, List<String>> = mapOf(
        Category.VIOLENCE_PHYSICAL to listOf(
            ...
            // Hebrew — passive/active conjugations that previously slipped through
            "נשרף", "נשרפת", "נשרפים", "נשרפה", "שורף", "שורפת", "לשרוף", "שרף",
            "בוער", "בוערת", "בוערים", "עולה באש", "עלה באש", "עלתה באש",
            "נכווה", "נכוותה", "כוויה",
            "נפצע", "נפצעת", "נפצעים",
            "התפוצץ", "התפוצצה", "מתפוצץ", "מתפוצצת", "מתפוצצים",
            "הותקף", "הותקפה", "מותקף", "מותקפת",
            "נהרג", "נהרגה", "נהרגים", "נרצח", "נרצחת", "נרצחים",
            "טובע במים", "טביעה",
            "נחנק", "נחנקת", "נחנקים",
            // Arabic
            "قتال", "ضرب", "عنف", "حرب"
    ...
    private val violentShows = listOf(
        ...
        // Shock / prank persona channels repeatedly reported by parents
        "יואבי נשרף", "יואבי נפצע", "יואבי מפחיד", "יואבי והאמא",
